...
sys.stdout = open("CFLP_DSAnoSGR_output.log", "w")
...
for solution in solution_reports: 
    ...
    pu_new.to_file(f"CFLP_wDSA_noSGR{solution_number}.geojson", driver="GeoJSON")


# In[94]:


with open('CFLP_wDSA_noSGR.json', 'w') as f:
