...
sys.stdout = open("CFLP_halfSGR_output_v4.log", "w")
...
for solution in solution_reports: 
    ...
    pu_new.to_file(f"CFLP_hs_halfSGR_v4{solution_number}.geojson", driver="GeoJSON")


with open('CFLP_hs_halfSGR_v4.json', 'w') as f:
