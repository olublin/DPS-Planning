...
sys.stdout = open("CFLP_halfSGR_output_v3.log", "w")
...
for solution in solution_reports: 
    ...
    pu_new.to_file(f"CFLP_hs_halfSGR_v3{solution_number}.geojson", driver="GeoJSON")


with open('CFLP_hs_halfSGR_v3.json', 'w') as f:
