...
sys.stdout = open("CFLP_DSAhalfSGR_output.log", "w")
...
pu_dict[566] = 1240
pu_dict[290] = 1335 
pu_dict[584] = 500 # include new DSA with capacity 500 for base students
...
for solution in solution_reports: 
    ...
    pu_new.to_file(f"CFLP_wDSA_halfSGR{solution_number}.geojson", driver="GeoJSON")


# In[94]:


with open('CFLP_wDSA_halfSGR.json', 'w') as f:
